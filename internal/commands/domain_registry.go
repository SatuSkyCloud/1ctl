...
func domainsDNSCommand() *cli.Command {
	...
	updateFlags := []cli.Flag{
		&cli.StringFlag{Name: "type", Usage: "DNS record type"},
...
func domainsPurchaseCommand() *cli.Command {
	return &cli.Command{
		Name:      "purchase",
		Usage:     "Start checkout for a domain purchase",
		ArgsUsage: "<domain>",
		Flags: []cli.Flag{
			&cli.IntFlag{Name: "period", Usage: "Registration period in years", Value: 1},
			&cli.StringFlag{Name: "first-name", Required: true},
			&cli.StringFlag{Name: "last-name", Required: true},
			&cli.StringFlag{Name: "email", Required: true},
			&cli.StringFlag{Name: "phone-country-code", Required: true},
			&cli.StringFlag{Name: "phone-number", Required: true},
			&cli.StringFlag{Name: "street", Required: true},
			&cli.StringFlag{Name: "street-number", Required: true},
			&cli.StringFlag{Name: "postal-code", Required: true},
			&cli.StringFlag{Name: "city", Required: true},
			&cli.StringFlag{Name: "state"},
			&cli.StringFlag{Name: "country", Usage: "Two-letter ISO country code", Required: true},
			&cli.StringFlag{Name: "company"},
		},
